...
extension CDItemDetailsView {
    ...
    class ViewModel: ObservableObject {
        ...
        @Published var objectNames: [String] = [] {
            didSet{
                typeListVM.arrayTypesListVM.objectNames = objectNames
            }
        }
        ...
        init(item: Item?) {
            ...
            // Set type
            typeListVM.selectedType = item.getValueType()
            ...
            typeCellVM.text = typeListVM.typeAndValueText(of: item.getValueType())
